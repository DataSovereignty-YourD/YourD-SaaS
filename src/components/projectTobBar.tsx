...
export default function ProjectTopBar() {
  ...
  return (
    <div className="h-[48px] flex ">
      ...
      <button
        className="flex items-center justify-center p-2 text-gray-700 hover:bg-gray-300 rounded-md ml-9"
        type="button"
      >
        <span>
          <svg
      ...
      <div className="flex justify-between w-full  ">
        <div className="flex">
          <div className="search-icon" onClick={handleSearchIconClick}>
            {
              <svg
                className="h-8 w-8 text-blue-500 mt-2 ml-2"
                width="24"
                height="24"
                viewBox="0 0 24 24"
                stroke-width="2"
          ...
          {isSearchBarVisible && (
            <div>
              <input
                ...
                type="text"
                className="w-48 py-1 px-2 rounded-md border border-gray-300 focus:outline-none focus:border-blue-500 mt-2 ml-2"
                value=""
              ></input>
            </div>
          )}
        ...
        <div className="">
          <div className="flex">
            <svg
              className="h-8 w-8 text-gray-500 mt-2"
              fill="none"
              viewBox="0 0 24 24"
              stroke="currentColor"
            >
            ...
            <svg
              className="h-8 w-8 text-gray-600 mt-2 ml-2"
              width="24"
              height="24"
              viewBox="0 0 24 24"
              stroke-width="2"
            ...
            <img
              className=" w-10 h-10 rounded-full object-cover mt-1 flex justify-end ml-3 mr-4"
              src="http://wiki.hash.kr/images/d/d6/이더리움_로고.png"
              alt="User Avatar"
            ></img>

            <img
              className=" w-10 h-10 rounded-full object-cover mt-1 flex justify-end ml-1 mr-4"
