    ...
    return (
        <div className="border-r-2 pr-2 min-h-[90vh] h-full">
            ...
            <div id="menu" className="flex flex-col space-y-2 my-5">
                <Link to={'dashboard'} state={{item:item}} className="hover:bg-white/10 transition duration-150 ease-linear rounded-lg py-3 px-2 group">
                ...
                <Link to={'apikey'} state={{item:item}} className="hover:bg-white/10 transition duration-150 ease-linear rounded-lg py-3 px-2 group">
                    <div className="relative flex flex-col space-y-2 md:flex-row md:space-y-0 space-x-2 items-center">
                        ...
                        <div>
                            <p className="font-bold text-base lg:text-lg text-black leading-4 group-hover:text-indigo-400">API KEY</p>
                            <p className="text-slate-400 text-sm hidden md:block">Manage API KEY</p>
                        </div>
                ...
                <div className="hover:bg-white/10 transition duration-150 ease-linear rounded-lg py-3 px-2 group">
                    <div className="flex flex-col space-y-2 md:flex-row md:space-y-0 space-x-2 items-center">
                        ...
                        <div>
                            <p className="font-bold text-base lg:text-lg text-black leading-4 group-hover:text-indigo-400">Users</p>
