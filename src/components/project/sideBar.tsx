            ...
            <div id="menu" className="flex flex-col space-y-2 my-5">
                {sideBarData.map((data, index) => (
                    <Link
                        key={index}
                        to={data.path}
                        className="flex flex-col space-y-2 md:flex-row md:space-y-0 md:space-x-2 items-center hover:bg-white group transition duration-150 ease-linear rounded-lg group w-full py-3 px-2"
                    >
                        <div>
                            <svg
